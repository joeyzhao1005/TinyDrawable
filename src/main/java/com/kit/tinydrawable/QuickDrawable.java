...
public class QuickDrawable {
    ...
    public QuickDrawable border() {
        borderWidth = DensityUtils.dip2px(1);
        return this;
    }

    public QuickDrawable border(int width) {
        this.borderWidth = DensityUtils.dip2px(width);
        return this;
    }
    ...
    public QuickDrawable corner(int topLeft, int topRight, int bottomLeft, int bottomRight) {
        this.topLeftRadius = DensityUtils.dip2px(topLeft);
        this.topRightRadius = DensityUtils.dip2px(topRight);
        this.bottomLeftRadius = DensityUtils.dip2px(bottomLeft);
        this.bottomRightRadius = DensityUtils.dip2px(bottomRight);
        return this;
    }
